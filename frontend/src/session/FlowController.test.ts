...
describe("ScreenKey exhaustiveness", () => {
  const allScreenKeys: ScreenKey[] = ["startup", "loading", "town", "hero-detail", "building-detail", "expedition-planning", "provisioning", "expedition", "result", "return", "unsupported", "fatal"];
